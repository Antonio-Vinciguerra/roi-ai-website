(async () => {
 ...
 function addMessage(role,text) {
  ...
  const speaker=document.createElement('span');speaker.className='speaker';speaker.textContent=role==='user'?"Tu":'ROI AI';
  article.append(speaker,document.createTextNode(text));log.append(article);log.scrollTop=log.scrollHeight;
 }
 addMessage('assistant',live ? "Ciao. Su cosa vorresti fare chiarezza riguardo alla tua impresa o ai tuoi progetti tecnologici?" : "Ciao, benvenuto in ROI AI. Puoi esplorare il nostro approccio e dove potremmo aiutare la tua impresa. Questa anteprima usa risposte guidate; il consulente AI arriverà in seguito.");
 function stopVoice() {
