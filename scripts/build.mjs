...
const legacy = `${head('Explore Heading South','Our capabilities and sectors.')}<main id="main" class="section"><h1>Find your starting point.</h1><ul>${Object.entries(names).map(([key,name])=>`<li><a href="${key}.html">${escape(name)}</a></li>`).join('')}</ul></main>${footer}<script src="legacy-route.js"></script></body></html>`;
