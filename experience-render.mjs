...
export function capabilityCards(){
 ...
 <div class="story-backdrop" aria-hidden="true">${cards.map(([key],i)=>`<div class="story-landscape" data-landscape="${i}"><img src="assets/${experiences[key].image}.webp" alt="" width="1600" height="900" loading="lazy"></div>`).join('')}<div class="story-shade"></div><div class="story-running-label"><span>Heading South / In your world</span><span data-story-count>01 — 03</span></div><div class="story-progress"><i></i></div></div>
