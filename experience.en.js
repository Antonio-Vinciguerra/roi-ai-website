import { experiences } from './experience-data.en.mjs';
...
for(const lens of document.querySelectorAll('[data-lens]')){
 ...
 function render(nextKey,index=0){
  ...
  const link=lens.querySelector('[data-lens-link]');if(link){link.href=key+".en.html?scenario="+selection;link.textContent='Explore '+e.name+' ↗';}
