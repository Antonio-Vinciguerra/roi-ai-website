(async () => {
 ...
 function addMessage(role,text) {
  ...
  const speaker=document.createElement('span');speaker.className='speaker';speaker.textContent=role==='user'?"Você":'ROI AI';
  article.append(speaker,document.createTextNode(text));log.append(article);log.scrollTop=log.scrollHeight;
 }
 addMessage('assistant',live ? "Olá. O que você gostaria de esclarecer sobre seu negócio ou seus planos de tecnologia?" : "Olá, boas-vindas à ROI AI. Você pode explorar nossa abordagem e onde poderíamos ajudar seu negócio. Esta prévia usa respostas guiadas; o consultor de IA virá depois.");
 function stopVoice() {
